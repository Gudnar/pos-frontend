<template>
  <div style="height:100%;overflow-y:auto;padding:24px;">
    ...
    <div v-else-if="items.length === 0" class="ide-ia-card" style="text-align:center;padding:48px 24px;">
      ...
      <div style="font-size:16px;font-weight:700;color:#e2e8f0;margin-bottom:8px;">Sin clientes aún</div>
      <p style="color:#64748b;margin-bottom:20px;font-size:13px;">Agrega tus clientes para mantener un registro organizado de tu cartera</p>
      <button class="ct-new-btn" @click="abrirDialog()">+ Nuevo Cliente</button>
    </div>
        ...
        <div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:10px;">
          <div style="display:flex;align-items:center;gap:10px;">
            ...
            <div>
              ...
              <div style="font-size:11px;color:#64748b;">{{ item.grupo || 'Sin grupo' }}</div>
            </div>
          </div>
