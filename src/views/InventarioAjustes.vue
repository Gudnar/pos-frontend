...
.inv-panel { background:#0d1526; border:1px solid #1e3a5f44; border-radius:12px; display:flex; flex-direction:column; overflow:hidden; }
...
.ct-spinner { width:24px; height:24px; border-radius:50%; border:3px solid #1e3a5f44; border-top-color:#6366f1; animation:spin .8s linear infinite; display:inline-block; }
