          ...
          <div v-for="m in historial" :key="m.id" class="inv-hist-item">
            <div class="inv-hist-top">
              <span class="inv-hist-prod">
                ...
                <span v-else class="inv-mono">{{ m.productoNombre || m.productoId || '—' }}</span>
              </span>
        ...
        <div class="inv-form">
          ...
          <div class="ide-field" style="position:relative;">
            ...
            <div style="position:relative;">
              ...
              />
              <button v-if="form.productoId || busquedaProd" class="adj-clear-btn" @mousedown.prevent="limpiarProd">✕</button>
            </div>
...
.adj-clear-btn { position:absolute; right:8px; top:50%; transform:translateY(-50%); background:none; border:none; cursor:pointer; color:var(--t4); font-size:12px; padding:2px 4px; line-height:1; }
.adj-clear-btn:hover { color:var(--t1); }
