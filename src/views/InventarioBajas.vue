        ...
        <div class="inv-form">
          ...
          <div class="ide-field" style="position:relative;">
            ...
            <div style="position:relative;">
              ...
              />
              <button v-if="form.productoId || busquedaProd" class="baj-clear-btn" @mousedown.prevent="limpiarProd">✕</button>
            </div>
...
.baj-clear-btn { position:absolute; right:8px; top:50%; transform:translateY(-50%); background:none; border:none; cursor:pointer; color:var(--t4); font-size:12px; padding:2px 4px; line-height:1; }
.baj-clear-btn:hover { color:var(--t1); }
